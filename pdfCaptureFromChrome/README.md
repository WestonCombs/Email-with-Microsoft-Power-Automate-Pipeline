...
The **Shipping status / POD capture** window uses **Assisted PDF Capture**, **Play/Pause**, and **Ctrl+Shift+P** in the isolated capture Chrome. Implementation: **`html_capture/`** (Chrome DevTools `Page.printToPDF`).
